...
select * from employees ORDER BY first_name, last_name limit 20;
...
SELECT COUNT(*) FROM employees WHERE YEAR(hire_date)=1988 AND gender='M'
...
SELECT COUNT(*) FROM employees WHERE YEAR(hire_date)>=1995 AND YEAR(hire_date)<=1999

SELECT COUNT(*) FROM employees WHERE YEAR(hire_date) BETWEEN 1995 AND 1999
