...
// 수정사항
// 타입 캐스트 연산자를 사용해 const char* 리터럴을 char*로 캐스팅해 초기화했습니다.
// 프로젝트 속성에서 유니코드 문자집합을 멀티바이트 문자집합으로 수정했습니다.
...
int main(int argc, char *argv[])
{
	...
	/*----------------*/
	// 원래의 IPv6 주소 출력
	char *ipv6test = const_cast<char*>("2001:0230:abcd:ffab:0023:eb00:ffff:1111");
